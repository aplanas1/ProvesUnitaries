...
public class HashTable {
     ...
     */
    public void put(String key, /*String*/ Object value) {
        ...
        if(entries[hash] != null) {
            ...
            if (temp != null) {
                ...
                if (temp.prev == null) {
                    ...
                    // Eliminar cuando es el primero de las colisiones
                    else {
                        temp.next.prev = null;
                        entries[hash] = temp.next;
                    }
                } else {
                    // Eliminar cuando tiene colisiones antes y despues
                    if (temp.next != null) {
                        temp.next.prev = temp.prev;
                        temp.prev.next = temp.next;
                    }
                    // Eliminar el ultimo de las colisiones
                    else {
                        temp.prev.next = null;
                    }
                }
