...
/*
    ...
    3. Grava en vídeo el següent:
        3.1. Mostra les modificacions que has fet el projecte per a poder fer servir Maven.
            - Modificación de Maven:
                - Añadir el support framework de maven (click derecho en la carpeta principal del proyecto).
                - Modificar el project structure para que este bonito y bien (cambiar el source y indicar el resource).
                - Añadir los plugins al pom.
        ...
        3.2. Mostra el log de GitHub, en concret la línia on es veuen les proves executades, per a demostrar que
             ...
             - Pruebas al git:
                ...
                - Actions -> Java with Maven, cambiar en la ultima linea package por test.
                - Ahora al entrar en actions se vera como se ejecuta la prueba.

                - Enseñar la linea de cuantos tests se han ejecutado, localizado en la ultima linea del "build with maven".
